    ...
    <a href="billing.php" style="text-decoration: none;">
        <div class="card bg-primary text-white text-center">
            <div class="card-body d-flex justify-content-center align-items-center" style="height: 100px;">
                <h3 class="card-title m-0 w-100">BILLING</h3>
            </div>
        </div>
    </a>
</div>
                    ...
                    <div class="col-sm-3">
                        ...
                        <div class="col-sm-3">
                            <a href="receiving.php" style="text-decoration: none;">
                                ...
                                <div class="card bg-danger text-white">
                                    <div class="card-body">
                                        <div class="d-md-flex align-items-center">
                                            <div>
                                                <?php 
                                                $drug_expiry_date = date('Y-m-d'); // Make sure this variable is set
        ...
        <div class="card bg-info text-white">
            <div class="card-body">
                <div class="d-md-flex align-items-center">
                    <div>
                        <?php 
                        $sql = "SELECT COUNT(*) as pending_count FROM purchase_order WHERE status = '0'";
                        $res = mysqli_query($conn, $sql);
                        $data = mysqli_fetch_assoc($res);
                        ?>
                        <h4 class="card-title">Bills Pending</h4>
                        <h2 class="card-title"><?php echo $data['pending_count']; ?></h2>
                    </div>
                </div>
            </div>
        </div>
