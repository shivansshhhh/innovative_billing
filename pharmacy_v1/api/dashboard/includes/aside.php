                ...
                <nav class="sidebar-nav">
                    <ul id="sidebarnav">
                        ...
                        <li class="sidebar-item"> <a class="sidebar-link waves-effect waves-dark sidebar-link"
                                href="dashboad.php" aria-expanded="false"><i class="mdi mdi-view-dashboard"></i><span
                                    class="hide-menu">Dashboard</span></a></li>
                     
						<li class="sidebar-item"> <a class="sidebar-link waves-effect waves-dark sidebar-link"
                                href="pharmacy_stock.php" aria-expanded="false"><i
                                    class="mdi mdi-clipboard-text"></i><span class="hide-menu">Ethical Phamacy Stock</span></a></li>
									<li class="sidebar-item"> <a class="sidebar-link waves-effect waves-dark sidebar-link"
                                href="receiving.php" aria-expanded="false"><i
                                    class="mdi mdi-home"></i><span class="hide-menu">Generic Store</span></a></li>
                       
						<li class="sidebar-item"> <a class="sidebar-link waves-effect waves-dark sidebar-link"
                                href="medicine_list.php" aria-expanded="false"><i class="mdi mdi-clipboard-text"></i><span
                                    class="hide-menu"> All Medicine List</span></a></li>
                        ...
                        <li class="sidebar-item">
                                <a href="billing.php" class="sidebar-link waves-effect waves-dark">
                                    <i class="mdi mdi-cash"></i><span class="hide-menu">Billing</span></a></li>
