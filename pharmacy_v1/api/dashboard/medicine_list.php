									   ...
									   ?>
																<tbody id="output">
																	<tr>
																		...
																		<td>
                                                                             <a  href="update_price.php?id=<?php echo "$id"?> && dosage_sold=<?php echo "$dosage_sold"?>" class="btn btn-success" type="button">Update Price</a>
                                                                    
                                                                        <a  href="manage_receiving.php?id=<?php echo "$id"?> && dosage_sold=<?php echo "$dosage_sold"?>" class="btn btn-success" type="button">Medicine Details</a>
                                        </td>
                                                                    </tr>
																</tbody>
